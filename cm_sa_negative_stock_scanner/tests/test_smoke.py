"""Smoke test for cm_sa_negative_stock_scanner.
...
class TestModuleSmoke(TransactionCase):
    def test_module_marked_installed(self):
        ...
        mod = self.env["ir.module.module"].search([("name", "=", "cm_sa_negative_stock_scanner")])
        self.assertTrue(mod, "cm_sa_negative_stock_scanner module record missing")
