"""Smoke test for cm_sa_vendor_scorecard.
...
class TestModuleSmoke(TransactionCase):
    def test_module_marked_installed(self):
        ...
        mod = self.env["ir.module.module"].search([("name", "=", "cm_sa_vendor_scorecard")])
        self.assertTrue(mod, "cm_sa_vendor_scorecard module record missing")
