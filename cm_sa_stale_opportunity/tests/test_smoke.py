"""Smoke test for cm_sa_stale_opportunity.
...
class TestModuleSmoke(TransactionCase):
    def test_module_marked_installed(self):
        ...
        mod = self.env["ir.module.module"].search([("name", "=", "cm_sa_stale_opportunity")])
        self.assertTrue(mod, "cm_sa_stale_opportunity module record missing")
