"""Smoke test for cm_sa_data_quality.
...
class TestModuleSmoke(TransactionCase):
    def test_module_marked_installed(self):
        ...
        mod = self.env["ir.module.module"].search([("name", "=", "cm_sa_data_quality")])
        self.assertTrue(mod, "cm_sa_data_quality module record missing")
