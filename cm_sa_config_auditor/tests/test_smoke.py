"""Smoke test for cm_sa_config_auditor.
...
class TestModuleSmoke(TransactionCase):
    def test_module_marked_installed(self):
        ...
        mod = self.env["ir.module.module"].search([("name", "=", "cm_sa_config_auditor")])
        self.assertTrue(mod, "cm_sa_config_auditor module record missing")
