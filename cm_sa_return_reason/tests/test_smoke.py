"""Smoke test for cm_sa_return_reason.
...
class TestModuleSmoke(TransactionCase):
    def test_module_marked_installed(self):
        ...
        mod = self.env["ir.module.module"].search([("name", "=", "cm_sa_return_reason")])
        self.assertTrue(mod, "cm_sa_return_reason module record missing")
