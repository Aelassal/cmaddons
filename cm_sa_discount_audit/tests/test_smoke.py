"""Smoke test for cm_sa_discount_audit.
...
class TestModuleSmoke(TransactionCase):
    def test_module_marked_installed(self):
        ...
        mod = self.env["ir.module.module"].search([("name", "=", "cm_sa_discount_audit")])
        self.assertTrue(mod, "cm_sa_discount_audit module record missing")
