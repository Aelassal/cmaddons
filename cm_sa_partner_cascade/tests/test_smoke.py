"""Smoke test for cm_sa_partner_cascade.
...
class TestModuleSmoke(TransactionCase):
    def test_module_marked_installed(self):
        ...
        mod = self.env["ir.module.module"].search([("name", "=", "cm_sa_partner_cascade")])
        self.assertTrue(mod, "cm_sa_partner_cascade module record missing")
