"""Smoke test for cm_sa_filestore_sweeper.
...
class TestModuleSmoke(TransactionCase):
    def test_module_marked_installed(self):
        ...
        mod = self.env["ir.module.module"].search([("name", "=", "cm_sa_filestore_sweeper")])
        self.assertTrue(mod, "cm_sa_filestore_sweeper module record missing")
