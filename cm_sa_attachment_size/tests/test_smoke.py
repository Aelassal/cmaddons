"""Smoke test for cm_sa_attachment_size.
...
class TestModuleSmoke(TransactionCase):
    def test_module_marked_installed(self):
        ...
        mod = self.env["ir.module.module"].search([("name", "=", "cm_sa_attachment_size")])
        self.assertTrue(mod, "cm_sa_attachment_size module record missing")
