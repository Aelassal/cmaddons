"""Smoke test for cm_sa_payment_score.
...
class TestModuleSmoke(TransactionCase):
    def test_module_marked_installed(self):
        ...
        mod = self.env["ir.module.module"].search([("name", "=", "cm_sa_payment_score")])
        self.assertTrue(mod, "cm_sa_payment_score module record missing")
