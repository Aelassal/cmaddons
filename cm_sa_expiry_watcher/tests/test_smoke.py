"""Smoke test for cm_sa_expiry_watcher.
...
class TestModuleSmoke(TransactionCase):
    def test_module_marked_installed(self):
        ...
        mod = self.env["ir.module.module"].search([("name", "=", "cm_sa_expiry_watcher")])
        self.assertTrue(mod, "cm_sa_expiry_watcher module record missing")
