"""Smoke test for cm_sa_lost_reason_enforcer.
...
class TestModuleSmoke(TransactionCase):
    def test_module_marked_installed(self):
        ...
        mod = self.env["ir.module.module"].search([("name", "=", "cm_sa_lost_reason_enforcer")])
        self.assertTrue(mod, "cm_sa_lost_reason_enforcer module record missing")
