"""Smoke test for cm_sa_transfer_sla.
...
class TestModuleSmoke(TransactionCase):
    def test_module_marked_installed(self):
        ...
        mod = self.env["ir.module.module"].search([("name", "=", "cm_sa_transfer_sla")])
        self.assertTrue(mod, "cm_sa_transfer_sla module record missing")
