"""Smoke test for cm_sa_renewal_pipeline.
...
class TestModuleSmoke(TransactionCase):
    def test_module_marked_installed(self):
        ...
        mod = self.env["ir.module.module"].search([("name", "=", "cm_sa_renewal_pipeline")])
        self.assertTrue(mod, "cm_sa_renewal_pipeline module record missing")
