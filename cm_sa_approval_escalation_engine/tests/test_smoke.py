"""Smoke test for cm_sa_approval_escalation_engine.
...
class TestModuleSmoke(TransactionCase):
    def test_module_marked_installed(self):
        ...
        mod = self.env["ir.module.module"].search([("name", "=", "cm_sa_approval_escalation_engine")])
        self.assertTrue(mod, "cm_sa_approval_escalation_engine module record missing")
