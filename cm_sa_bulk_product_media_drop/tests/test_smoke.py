"""Smoke test for cm_sa_bulk_product_media_drop.
...
class TestModuleSmoke(TransactionCase):
    def test_module_marked_installed(self):
        ...
        mod = self.env["ir.module.module"].search([("name", "=", "cm_sa_bulk_product_media_drop")])
        self.assertTrue(mod, "cm_sa_bulk_product_media_drop module record missing")
