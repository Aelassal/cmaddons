"""Smoke test for cm_sa_margin_guard.
...
class TestModuleSmoke(TransactionCase):
    def test_module_marked_installed(self):
        ...
        mod = self.env["ir.module.module"].search([("name", "=", "cm_sa_margin_guard")])
        self.assertTrue(mod, "cm_sa_margin_guard module record missing")
