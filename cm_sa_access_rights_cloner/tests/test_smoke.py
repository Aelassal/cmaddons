"""Smoke test for cm_sa_access_rights_cloner.
...
class TestModuleSmoke(TransactionCase):
    def test_module_marked_installed(self):
        ...
        mod = self.env["ir.module.module"].search([("name", "=", "cm_sa_access_rights_cloner")])
        self.assertTrue(mod, "cm_sa_access_rights_cloner module record missing")
