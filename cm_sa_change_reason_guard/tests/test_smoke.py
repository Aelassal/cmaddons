"""Smoke test for cm_sa_change_reason_guard.
...
class TestModuleSmoke(TransactionCase):
    def test_module_marked_installed(self):
        ...
        mod = self.env["ir.module.module"].search([("name", "=", "cm_sa_change_reason_guard")])
        self.assertTrue(mod, "cm_sa_change_reason_guard module record missing")
