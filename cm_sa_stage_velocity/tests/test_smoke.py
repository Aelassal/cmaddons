"""Smoke test for cm_sa_stage_velocity.
...
class TestModuleSmoke(TransactionCase):
    def test_module_marked_installed(self):
        ...
        mod = self.env["ir.module.module"].search([("name", "=", "cm_sa_stage_velocity")])
        self.assertTrue(mod, "cm_sa_stage_velocity module record missing")
